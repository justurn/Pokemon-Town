/// @description Draw side panel with stat comparison info and item sprite above Pokemon
// Following OBJ_Master_Lab pattern for consistent UI
...
if (panel_stat_name != "")
{
    ...
    // IV comparison
    var iv_text = "IV: " + string(panel_old_iv) + " -> " + string(panel_new_iv) + " (+" + string(panel_items_used) + ")";
